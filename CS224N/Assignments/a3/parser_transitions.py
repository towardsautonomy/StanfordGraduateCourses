...
class PartialParse(object):
    def __init__(self, sentence):
        ...
        ###
        ### Note: The root token is represented with the string "ROOT"
        self.stack = ['ROOT']
    ...
    def parse_step(self, transition):
        ...
        """
        ###     This function implements a single parsing step:
        ###         1. Shift
        ###         2. Left Arc
        ###         3. Right Arc
        if transition == "S":
            ...
            element = self.stack.pop(-2)
            self.dependencies.append((self.stack[-1], element))
        elif transition == "RA":
